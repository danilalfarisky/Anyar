    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 px-5 py-4 text-[#FAF8F5]" onClick={stop}>
        ...
        <a
          ...
          rel="noreferrer"
          download
          className="inline-flex shrink-0 items-center gap-2 rounded-full border border-white/20 px-4 py-2 text-xs font-medium text-[#FAF8F5] transition-colors hover:bg-white/10"
        >
